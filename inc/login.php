      ...
      <form action="index.php" method="get" class="form">
       <input type="hidden" value="<?= $lang ?>" name="lang" />
        <div id="formGroup" class="form-group">
          <h2 class="form-signin-heading"><?= $pagecontent["login_title"] ?></h2>
          ...
          <button id="submit" class="btn btn-lg btn-success btn-block mt-2" type="submit"><?= $pagecontent["login_button"] ?></button>
        </div>
      </form>
