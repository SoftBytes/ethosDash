			...
			foreach($per_rig_info as $rigname=>$rigstats){
				...
				if($rigstats["condition"]!="xxxxxx"){
					...
					$renderhtml = '<div class="riglist_row">
									...
									<span class="power_consumes">'.$datalyser->rigPower($rigstats["watts"],$rigstats["gpus"]).'</span><span class="  power_consumes_units"> kWt</span></div>
									...
									<div class="riglist_cell table_pool"><span class="rack_loc">'.$this->labels["label19"].': </span><span>'.$rigstats["pool"].'</span></div>
								</div>';
